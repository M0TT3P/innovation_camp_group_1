<template>
    <AuthenticatedLayout>
        <div class="px-6 py-4">
            <h1 class="text-2xl font-bold mb-4">Chemic Analytics-Datensatz bearbeiten</h1>
...
const form = ref({
    see_id: props.chemicAnalytics.see_id,
    datum: props.chemicAnalytics.datum,
    wetter: props.chemicAnalytics.wetter,
    sonderzustand: props.chemicAnalytics.sonderzustand,
    temperatur: props.chemicAnalytics.temperatur,
    sauerstoffgehalt: props.chemicAnalytics.sauerstoffgehalt,
    ph: props.chemicAnalytics.ph,
    el: props.chemicAnalytics.el,
    ung_stoffe: props.chemicAnalytics.ung_stoffe,
    ammonium: props.chemicAnalytics.ammonium,
    nitrit: props.chemicAnalytics.nitrit,
    nitrat: props.chemicAnalytics.nitrat,
    ortho_p: props.chemicAnalytics.ortho_p,
    gesamt_p: props.chemicAnalytics.gesamt_p,
    np_verhaltnis: props.chemicAnalytics.np_verhaltnis,
    doc: props.chemicAnalytics.doc,
    chlorid: props.chemicAnalytics.chlorid,
    chlorophyll: props.chemicAnalytics.chlorophyll
})

const save = () => {
    Inertia.put(route('chemic-analytics.update', props.chemicAnalytics.id), form.value)
}
